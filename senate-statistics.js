...
function createLeastAndMostEngagedTables(idname, arr) {
    for (var i = 0; i < bottom10PctMembersByMissedVotes.length; i++) {
        var tableRow = document.createElement("tr");
...
createLeastAndMostEngagedTables("leastEngagedtbody",bottom10PctMembersByMissedVotes);
createLeastAndMostEngagedTables("mostEngagedBody",top10PctMembersByMissedVotes);